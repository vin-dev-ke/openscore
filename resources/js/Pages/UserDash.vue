<template>
        ...
        >
            <Link href="/">
                <div class="flex items-center">
                    ...
                    />
                    <h1
                        class="font-bold text-green-500 text-3xl uppercase ml-2 mb-0"
                    >
                        Open<span class="text-black">Score</span>
                    </h1>
                </div>
            </Link>
            <h2 class="text-white text-lg font-mono text-3xl uppercase">
                Scam Reports Forum
            </h2>
            <nav
                class="space-x-4 md:flex md:items-center md:space-x-4 mt-4 md:mt-0"
            >
                <Link
    ...
    >
        ...
        <div>
            <div class="grid grid-rows-2 gap-2">
                <div class="row-span-1">
                    <!-- User Profile -->
                    <h2
                        class="text-xl font-semibold mb-4 uppercase inline-flex"
                    >
                    ...
                    >
                        <span class="font-bold mr-1">{{ myScams }}</span> posted
                        scams
                    </span>
                </div>

                <h1 class="mb-2 font-semibold text-2xl ml-2">
                    Make a Quick Scam Report
                </h1>

                <div class="row-span-1 -mt-26">
                    <div
                        class="bg-green-200 shadow-lg rounded px-8 pt-2 pb-8 mb-4 flex flex-col"
                    >
                                ...
                                <div class="md:w-1/2 px-3">
                                    ...
                                    >
                                        <option value="" disabled>
                                            Select a scam activity
                                        </option>
                                        <option value="fakeProduct">
                                            Fake products seller
                                        </option>
                                        <option value="fakeService">
                                            Fake service provider
                                        </option>
                                        <option value="fakeEmployer">
                                            Con employer
                                        </option>
                                        <option value="fakeEmployee">
                                            Con employee
                                        </option>
                                    </select>
                                </div>
        ...
        <div>
            <div class="grid grid-rows-2 gap-2">
                <h1
                    class="font-semibold text-2xl leading-5 uppercase text-gray-500"
                >
                    Recent scam reports
                </h1>
                ...
                <div class="row-span-1">
                    ...
                    >
                        ...
                        >
                            <span
                                class="font-semibold title-font text-gray-700 uppercase"
                                >{{ scam.user.name }}</span
                            >
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 ml-2">
                        ...
                        >
                            <div
                                class="bg-white p-4 rounded-lg w-96 relative mt-8 mx-auto my-auto"
                            >
                                <!--Modal close button -->
                                <button
                                ...
                                <div v-if="comments && comments.length > 0">
                                    <div class="grid grid-cols-3 gap-4">
                                        ...
                                        >
                                            ...
                                            <p
                                                class="text-gray-800 mt-2 font-bold"
                                            >
                                                {{ comment.content }}
                                            </p>
                                            <!-- Delete comment -->
                                            <div
                                                class="flex justify-end mt-3 absolute bottom-0 right-0"
                                            >
                                                <button
                                                    v-if="
                                                        comment.user_id ===
                                ...
                                <div v-else>
                                    <span class="text-gray-400 text-md"
                                        >No comments for this post</span
                                    >
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Paginator -->
                    <div
                        class="order-last mt-4 p-2 flex items-center justify-center"
                    >
                        <Link
...
export default {
    ...
    methods: {
        search: _.throttle(function () {
            this.$inertia.get(
                this.route("dashboard", { search_term: this.search_term })
            );
        }, 200),
        hideMiddleFour(contact) {
            if (contact.includes("@")) {
                ...
                return (
                    contact.substring(0, length - 4) +
                    hiddenDigits +
                    contact.substring(length - 1)
                );
            }
        },
        closeModal() {
